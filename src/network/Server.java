...
public class Server {
    ...
    private static void loginSuccessful() throws IOException {
    ...
    private static void createNewUserAccount() throws NoSuchAlgorithmException, NoSuchProviderException, IOException {
    ...
    private static void resetUserPassword() throws IOException {
