...
public enum RequestCode implements Serializable {
	...
	REQUEST_DOCUMENT_LIST(10), ADD_USER_AS_EDITOR(11), GET_REVISION_HISTORY(12),
	SEND_MESSAGE(13), REQUEST_USERS_ONLINE(14), START_CHAT_HANDLER(15), 
	CHANGE_OWNER(16), PRIVATE_CHAT(17), SEND_PRIVATE_MESSAGE(18);
