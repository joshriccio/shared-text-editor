...
public enum ResponseCode implements Serializable {
	...
	DOCUMENT_LISTS_SENT(10), USER_ADDED(11), USER_NOT_ADDED(12), USERS_LIST_SENT(13), NEW_USER_CONNECTED(14), NEW_MESSAGE(15), NEW_PRIVATE_MESSAGE(16), DOCUMENT_REFRESH(17);
